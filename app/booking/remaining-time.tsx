    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          style: "destructive",
          onPress: () => {
            Alert.alert("Session Ended", "Your parking session has been completed.");
    ...
    <View style={styles.container}>
      ...
      {isLowTime && (
        <View style={[styles.warningContainer, isCriticalTime && styles.criticalWarning]}>
          ...
          />
          <Text style={[styles.warningText, isCriticalTime && styles.criticalText]}>
      ...
      <View style={styles.detailsCard}>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailValue}>Parking {getZoneDisplay()}, Spot #{getSpotDisplay()}</Text>
        </View>
